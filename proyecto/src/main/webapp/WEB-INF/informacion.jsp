...
<body>
<header>
  <h1 class="titulo_imagen"><span class="textoborde">Educación Especial</span></h1>
</header>
<div class="audio">
  <audio controls>
    <source src="/informacion/audio.ogg" type="audio/ogg">
    <source src="/informacion/audio.mp3" type="audio/mpeg">
...
<main>
  ...
  <a name="subtitulo_tres" id="subtitulo_tres"></a>
  <h2 class="subtitulo_tres">¿CÓMO SABER SI UN NIÑO NECESITA EDUCACIÓN ESPECIAL?</h2>
  <div class="parrafo_tres">
    <p>
      A veces la tarea de reconocer si un niño necesita educación especial es una tarea difícil de identificar
      por lo que los padres pueden averiguarlo observando ciertos aspectos en su proceso de desarrollo y en su
      proceso escolar y cotidiano.
    </p>
    <p>Cada niño tiene su particular proceso de desarrollo, si bien hay algunas
      escalas que permiten darse una idea de lo que debería estar realizando en cada etapa, es necesario estar
      atentos a los procesos del niño. Si los padres observan que hay algunas conductas o situaciones en el
      desarrollo de sus hijos que no sean comunes es necesario referirlo a un profesional para que los oriente
      en lo que se debe hacer.</p>
  </div>
  ...
  <div class="parrafo_cuatro">
    <p>Con el médico de su hijo. Si su hijo tiene necesidades especiales que le dificultan el aprendizaje o
      parece ir atrasado en el desarrollo, explíqueselo a su médico. Él podrá ver si su hijo puede seguir el
      ritmo de la clase o necesita que lo evalúen. Es posible que tenga que verlo un especialista (como un
      terapeuta del habla o un psicólogo). Si es necesario, haga que lo evalúen. Un niño que necesita una
      ayuda especial para alcanzar los hitos evolutivos será derivado para que lo evalúen
    </p>
    <p>Participación de los padres en el proceso de toma de decisiones de educación especial es de vital
      importancia. Lo más importante que pueden hacer los padres es asegurarse de que estén involucrados y
      desempeñen un papel activo como miembro del equipo educativo de sus hijos. Se pensará la un plan
      educativo individualizado donde se tendrá en cuenta la evaluación, el desarrollo del programa y los
      programas educativos que se tendrán en cuenta a lo largo de la escolarización del pequeño.
    </p>
  </div>
  ...
  <div class="discapacidad_visual">
    <p>La discapacidad visual es la consideración a partir de la disminución total o parcial de la vista. Se
      mide a través de diversos parámetros, como la capacidad lectora de cerca y de lejos, el campo visual o
      la agudeza visual.</p>
  </div>
  <a name="disc_auditiva" id="disc_auditiva"></a>
  <h2 class="disc_auditiva">¿QUÉ ES LA DISCAPACIDAD AUDITIVA?</h2>
  <div class="discapacidad_auditiva">
    <p>La sordera puede ser el resultado de daños en el oído interno o los nervios. Puede ser ocasionada por un
      defecto congénito, lesiones, enfermedades, ciertos medicamentos, exposición a sonidos fuertes o el
      desgaste propio de la edad.
      El síntoma principal es la incapacidad de escuchar sonidos
    </p>
  </div>
  <a name="disc_intelectual" id="disc_intelectual"></a>
  <h2 class="disc_intelectual">¿QUÉ ES LA DISCAPACIDAD INTELECTUAL?</h2>
  <div class="discapacidad_intelectual">
    <p>Inteligencia y capacidades para desenvolverse por debajo del nivel promedio que se manifiestan antes de
      los dieciocho años.
      La función intelectual puede medirse con una prueba.
      El síntoma principal es la dificultad para pensar y comprender. Las destrezas para desenvolverse en la
      vida que se pueden ver afectadas incluyen determinadas habilidades prácticas, sociales y conceptuales.
    </p>
  </div>
  <div class="seccion_padres">
    <a name="subtitulo_cinco" id="subtitulo_cinco"></a>
    <h2 class="subtitulo_cinco">LA IMPORTANCIA DE LOS PADRES</h2>
    <div class="parrafo_cinco">
      <p>Aunque es sabido que los profesionales del equipo docente y del centro educativo toman decisiones
        sobre
        la educación de los niños, los padres también deben formar una parte activa en lo que concierne a su
        hijo en educación especial. Quizá esto pueda hacer que los padres se sienten de algún modo
        abrumados,
        pueden creer que los profesionales del centro considera que están poco informados sobre la enseñanza
        o
        los obstáculos que existen en la toma de decisiones, sobre todo si hay algún punto de discrepancias.
        Los
        padres y otros tutores no deben permitir que el personal de la escuela los intimide en este proceso,
        porque su papel como defensor del estudiante es de suma importancia.
      </p>
    </div>
    <a name="subtitulo_seis" id="subtitulo_seis"></a>
    <h3 class="subtitulo_seis">LOS PADRES APORTAN INFORMACIÓN VALIOSA</h3>
    <div class="parrafo_seis">
      <p>Los padres y tutores conocen a sus hijos mejor que nadie y tienen la comprensión más completa de la
        historia física, social, de desarrollo y familiar de un niño. Los padres son los únicos adultos en
        el proceso educativo que han estado y continuarán estando profundamente involucrados a lo largo de
        la carrera escolar del niño; y si bien ellos mismos no pueden ser educadores, aportan sus años de
        experiencia en otras profesiones y aspectos de la vida al proceso.</p>
    </div>
    <a name="subtitulo_siete" id="subtitulo_siete"></a>
    <h3 class="subtitulo_siete">LOS PADRES SON LOS MEJORES DEFENSORES DE SUS HIJOS</h3>
    <div class="parrafo_siete">
      <p>No hay nadie tan interesado y motivado para el éxito de un niño que sus propios padres, esto es lo
        más
        importante para tener en cuenta que ellos, los padres, deberían estar en el puesto número uno en el
        equipo de decisiones. </p>
    </div>
    <a name="subtitulo_ocho" id="subtitulo_ocho"></a>
    <h3 class="subtitulo_ocho">¿CÓMO TENER UN PAPEL MÁS ACTIVO?</h3>
    <div class="parrafo_ocho">
      <p>
        Aprende todo lo que puedas sobre discapacidad.
    ...
    <div>
      <div class="foto1">
        <img class="foto_1" src="/informacion/imagen 1 de 3.jpg" alt="">
        <img class="foto_2" src="/informacion/imagen 2 de 3.jpg" alt="">
        <img class="foto_3" src="/informacion/imagen 3 de 3.jpg" alt="">
      </div>
    </div>
    ...
    <div class="parrafo_pie">
      <p>El PIE (Programa de integración Escolar)es una estrategia inclusiva del sistema escolar, que tiene el
        ...
        establecimiento educacional, favoreciendo la presencia en la sala de clases, la participación y el
        logro de
        ...
        equiparar
        oportunidades de aprendizaje y participación para los niños y niñas.</p>
    </div>
    <br><br><br>
</main>
<footer>
